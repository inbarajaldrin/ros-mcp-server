...
> Moved from `CLAUDE.md` 2026-05-06 to keep the project memory file lean. This is reference material, consulted on demand. The `Verified Live` section is dated and may need re-verification.
