...
1. Call control_gripper with the gripper_width_mm value from get_scene_info for this grasp point
2. Call move_to_object to move to the grasp point
3. Call control_gripper with command='close' to grasp the object
...
4. Call control_gripper with the gripper_width_mm value to release the object
...
3. Call control_gripper with the gripper_width_mm value to release the object
4. Call move_to_safe_height to move to the safe height (z=0.3m)"""
...
2. Call control_gripper with the gripper_width_mm value to release the object"""
