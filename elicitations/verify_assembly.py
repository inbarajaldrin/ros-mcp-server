...
Used by Phase 3 (assembly execution) to get human confirmation that the
...
def build_elicitation_message(result: dict) -> str:
    ...
    if status == "success":
        message = "Phase 3 (Assembly Execution) - Assembly Complete\n\n"
        ...
        message = "Phase 3 (Assembly Execution) - Assembly Issue\n\n"
